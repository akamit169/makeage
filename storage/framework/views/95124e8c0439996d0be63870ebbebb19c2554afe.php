                ...
                <section class="vbox"> 
                    ...
                    <section class="scrollable wrapper w-f"> 
                        <div class="main-container">
                            <form action="<?php echo e(url('admin/user/delete-reported-user-reason')); ?>" id="delete_user" class="stream-form " method="post">
                                ...
                                <div class="row">
                                    <div class="panel-body"> 
                                        <div class="form-group"> 
                                            <input type="hidden" value="<?php echo e($userObj); ?>"   name="user_id" id="user_id" >
                                            <label>Reason</label> 
                                            <div class="">
