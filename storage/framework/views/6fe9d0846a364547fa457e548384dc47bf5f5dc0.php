<?php $__env->startSection('title'); ?> <?php echo e('Suspended User List'); ?> @parent  <?php $__env->stopSection(); ?> 
                ...
                <section class="vbox"> 
                    ...
                    <header class="header bg-white b-b b-light"> 
                        ...
                        <ul class="breadcrumb pull-right mr-t-7"> 
                            ...
                            <li class="active">Suspended User List</li> 
                        </ul>
                    </header> 
                    <!-- End of Page Heading -->     
...
<script src="<?php echo e(URL::asset('assets/admin/js/suspended_user_list.js')); ?>"></script>
