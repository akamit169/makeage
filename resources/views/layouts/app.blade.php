...
<script type="text/javascript" src="{{ asset('script/dataTables.bootstrap.js')}}" ></script>
<script type="text/javascript" src="{{ asset('script/dataTables.responsive.min.js')}}"></script>
<script type="text/javascript" src="{{ asset('script/responsive.bootstrap.min.js')}}" ></script>
